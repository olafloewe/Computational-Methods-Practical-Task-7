...
namespace Task_7 {
    internal class Program {
        ...
        static double Rand() {
            ...
            long time = long.Parse(DateTime.Now.ToFileTimeUtc().ToString().Substring(14));
            // long time = long.Parse(DateTime.Now.ToFileTimeUtc().ToString().Substring(0));
            Console.WriteLine($"time: {time} | {time.ToString().Length}");
            Console.ReadKey();
